...
import com.mobiquel.udhampur.network.NetworkUtils;
...
public class UploadOfflineDraftedIncidents extends BroadcastReceiver {
    ...
    protected void uploadContent(String path, final int pos) {
        try {
            ...
            NetworkUtils.uploadFile(AppConstants.BASE_URL + "uploadIncidentDoc", file, "file",
    ...
    private void submitIssueAPI(final String issueId) {
        ...
        StringRequest requestObject = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                // Toast.makeText(mContext, "Could not connect to server",
