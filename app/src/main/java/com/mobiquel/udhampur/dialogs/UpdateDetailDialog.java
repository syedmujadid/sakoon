...
public class UpdateDetailDialog extends Dialog {

    private Context mContext;
    private DialogListener dialogListener;
    private List<LocationListModel> mLocationList;
    public UpdateDetailDialog(Context context, DialogListener dialogListener) {
        super(context);
        mContext = context;
    ...
    public List<String> checkSolution() {
        ...
        } else if (etUserMobile.getText().toString().equals("")) {
            //Utils.showToast(mContext, "Please enter correct password!");
            data.add("Please enter mobile number!");

        } else {
            data.add(etUserName.getText().toString());
            data.add(etUserMobile.getText().toString());
